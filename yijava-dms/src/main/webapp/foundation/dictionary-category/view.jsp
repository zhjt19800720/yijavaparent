...
<link rel="stylesheet" type="text/css"
	href="../../resource/css/main.css">
<script type="text/javascript" src="../../resource/js/jquery-1.7.2.js"></script>
<script type="text/javascript"
	src="../../resource/js/jquery.easyui.min.js"></script>
<script type="text/javascript"
	src="../../resource/locale/easyui-lang-zh_CN.js"></script>
...
<body LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
	<div id="p" class="easyui-panel" title="">
		...
		<div style="margin: 10px 0;"></div>
		<div style="padding-left: 10px; padding-right: 10px">
			<table id="dg" title="查询结果" style="height: 420px"
				data-options="rownumbers:true,singleSelect:true,pagination:true,url:'/yijava-dms/api/foundation/dictionary-category/view',method:'get'">
				<thead>
					<tr>
						<th data-options="field:'name',width:200">类别名称</th>
						<th data-options="field:'code',width:200">类别代码</th>
					</tr>
				</thead>
			</table>
