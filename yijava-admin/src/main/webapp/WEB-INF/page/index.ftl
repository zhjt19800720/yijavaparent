...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="resources/scripts/jquery.treeview.edit.js"></script>
		<script type="text/javascript" src="resources/scripts/jquery.treeview.async.js"></script>
	    ...
	    <div id="main_container">
			...
			<div id="logo">
				...
				<div id="account">
					<ul>
						<li>
							<a href="#"><span class="user24_icon"><@shiro.principal type="com.yijava.admin.common.model.CommonVariableModel" property="user"/></span></a>
						    <ul>
	        ...
	        <div class="panel_footer" id="footer">
	        	Copyright © 2010-2013 yijava. Powered by yijava .
	        </div>
