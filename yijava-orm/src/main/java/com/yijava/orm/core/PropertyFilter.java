 ...
 * 写入表达式即可，相关表达式样式查看{@link com.yijava.orm.core.hibernate.CriterionBuilder}的实现类,如果直接创建查看{@link com.yijava.orm.core.hibernate.CriterionBuilder}
 ...
 * <p>当使用以上filter到{@link com.yijava.orm.core.hibernate.support.HibernateSupportDao#findUniqueByPropertyFilter(java.util.List)}是会产生以下sql</p>
